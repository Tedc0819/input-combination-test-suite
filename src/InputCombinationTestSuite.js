...
//   */
//
//  this.prototype.extraCombinations = [];
  ...
  runTest(test, combination) {
    ...
    return self.stub(test, combination)
      .then( () => self.setFixtures(test, combination) )
      .then( () => {
  ...
  run() {
    ...
    return describe(self.title(), function() {
      ...
      combinations.forEach(function(combination) {
        ...
        if (`${combination}` === `${self.only()}`) {

          describe.only(self.combinationTestTitle(shouldSuccess, combination), descFunc);
